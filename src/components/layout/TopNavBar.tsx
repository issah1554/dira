            ...
            <div className="h-full px-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        ...
                        {open === "notif" && (
                            <div className="absolute right-0 mt-2 w-64 bg-main-50 border border-main-200 rounded-sm shadow-lg text-main-600 text-sm z-50">
                                <div className="px-4 py-2 font-semibold">Notifications</div>
                                <div className="border-t border-main-200">
                                    <div className="px-4 py-2 hover:bg-main-200">
                                        New user registered
                                    </div>
                                    <div className="px-4 py-2 hover:bg-main-200">
                                        Backup completed
                                ...
                                <Link
                                    to="/notifications"
                                    className="block text-center px-4 py-2 border-t border-main-200 hover:border-primary-200 text-primary hover:bg-primary-100 rounded-b-sm"
                                >
                                    View all
                                </Link>
                            </div>
